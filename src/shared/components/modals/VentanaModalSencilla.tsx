...
import type { ModalSencillaProps } from "./modal.type";

function VentanaModalSencilla({ titulo, size = "full", children, show, cerrarModal, }: ModalSencillaProps) {

    return (
        <Modal show={show} size={size} onClose={cerrarModal} popup className="backdrop-blur">
...
export default VentanaModalSencilla;