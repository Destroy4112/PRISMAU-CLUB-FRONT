...
const Loading = () => {
   ...
   return (
      <div className="flex flex-col items-center justify-center h-[calc(100vh-5.5rem)] bg-linear-to-br from-green-100 via-blue-100 to-orange-100 relative overflow-hidden">
