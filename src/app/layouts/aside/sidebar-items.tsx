...
const SOCIO_ITEMS = [
   { isTitle: true, texto: "Pagos" },
   { icono: <CircleDollarSign className="text-purple-600" />, texto: "Mensualidades", link: PRIVATE_ROUTES.ADMINISTRADORES },
   { icono: <CircleDollarSign className="text-pink-600" />, texto: "Cuotas de Baile", link: PRIVATE_ROUTES.ROLES },
];
