...
const ADMIN_ITEMS = [
    ...
    { icono: <CircleDollarSign className="text-red-600" />, texto: "Gestión de Pagos", link: PRIVATE_ROUTES.GESTION_PAGOS, activeSubroutes: [PRIVATE_ROUTES.PAGAR, PRIVATE_ROUTES.RUBROS, PRIVATE_ROUTES.SOCIOS, PRIVATE_ROUTES.PROGRAMACION_PAGOS, PRIVATE_ROUTES.PAGOS_SOCIOS, PRIVATE_ROUTES.HISTORIAL_CUOTAS_BAILE, PRIVATE_ROUTES.HISTORIAL_MENSUALIDADES] },
];
