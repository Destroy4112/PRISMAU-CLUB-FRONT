...
const HobbiesPage = lazy(() => import('@/features/superAdmin/hobbies/HobbiesPage'))
const ContratosPage = lazy(() => import('@/features/superAdmin/contratos/ContratosPage'))

const SolicitudesPage = lazy(() => import('@/features/admin/solicitudes/SolicitudesPage'))
...
const FamiliaresAdherentePage = lazy(() => import('@/features/admin/familiares/FamiliaresAdherentePage'))
