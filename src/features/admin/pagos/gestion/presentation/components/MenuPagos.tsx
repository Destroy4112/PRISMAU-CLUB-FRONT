         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {MENUS_PAGO.map((item, index) => (
               <Link to={item.path} key={index} className="group relative">
                  <div className="relative h-full border border-gray-200 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden transform hover:-translate-y-2">
