...
import { CalendarDays, CreditCard, FilePlus, FileText, ReceiptText, WalletCards } from 'lucide-react'
import { FaMoneyBill } from 'react-icons/fa'
import type { FormMensualidadProps } from '../types/mensualidad'

export default function FormMensualidad({ form, handleChange, handleChangeFile }: FormMensualidadProps) {
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="space-y-5 rounded-3xl border border-slate-200 bg-white p-5">
                ...
                <div className="w-full space-y-2">
                    <label className="block text-sm font-medium text-gray-900">Soporte</label>
                    <label className="group flex cursor-pointer items-center gap-4 rounded-3xl border border-dashed border-slate-300 bg-slate-50 px-5 py-4 transition hover:border-emerald-400 hover:bg-white">
                        <div className="flex h-14 w-14 items-center justify-center overflow-hidden rounded-2xl bg-white shadow-sm">
                            <FilePlus className="h-6 w-6 text-emerald-600" />
                        </div>
                        <div>
                            <p className="text-sm font-bold text-slate-900">Subir logo</p>
                            <p className="text-xs text-slate-500">Formatos soportados: .jpg, .jpeg, .png, .pdf</p>
                        </div>
