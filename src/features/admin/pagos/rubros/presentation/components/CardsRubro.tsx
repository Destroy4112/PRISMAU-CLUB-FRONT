...
export default function CardsRubro({ rubros, loading, page, limit, total, onPageChange, onRowsPerPageChange, cargar, handleDelete }: CardsRubrosProps) {

    if (loading) return <CardSkeleton />
    if (!loading && !rubros?.length) return <NoData mensaje='No se encontraron rubros' />
