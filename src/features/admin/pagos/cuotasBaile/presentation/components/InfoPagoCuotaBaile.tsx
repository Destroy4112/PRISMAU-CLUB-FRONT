...
import type { InfoPagoCuotaBaileProps } from '../types/cuotaBaile';

export default function InfoPagoCuotaBaile({ pago, closeModal }: InfoPagoCuotaBaileProps) {
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500">
                                        CuotaBailees afectadas por el pago registrado.
                                    </p>
                                </div>
                            </div>
                        </div>
