...
import FacturaCuotaBailePdf from "@shared/components/preview/FacturaCuotaBailePdf";
import FilePreview from "@shared/components/preview/FilePreview";
...
import type { FacturaCuotaBaileProps } from "../types/cuotaBaile";

export default function FacturaCuotaBaile({ cuotaBaile, socio }: FacturaCuotaBaileProps) {

   const handleOpenPdfInNewTab = async () => {
      const blob = await pdf(<FacturaCuotaBailePdf cuotaBaile={cuotaBaile} socio={socio} />).toBlob();
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center p-4">
               <div className="flex items-center space-x-4">
                  ...
                  <div>
                     ...
                     <p className="text-xs text-gray-500">{cuotaBaile.descripcion}</p>
                  </div>
               </div>
                           ...
                           <TableBody>
                              {
                                 cuotaBaile.pagos.map((pago) => (
                                    <TableRow key={pago.id}>
                                       ...
                                       <TableCell>PAGO FACTURA {cuotaBaile.descripcion}</TableCell>
