...
type Props = {
    total: number;
    filters: AdministradorFilter;
    onSearchChange: (e: ChangeEvent<HTMLInputElement>) => void;
    onClearSearch: () => void;
};

export default function AdminToolbar({ total, filters, onSearchChange, onClearSearch }: Props) {
    return (
            ...
            <div className="flex flex-col gap-2 lg:flex-row lg:items-end lg:justify-between">
                <div className="px-2 py-0.5">
                    ...
                    <p className="mt-0.5 max-w-2xl text-sm text-slate-500">
                        Filtra para encontrar más rápidamente tus administradores.
                    </p>
                </div>
            ...
            <div className="flex flex-col gap-2 rounded-2xl p-1.5 lg:flex-row lg:items-center">
                <div className="relative flex-1">
                    ...
                    <input
                        ...
                        placeholder="Buscar por nombre, ciudad, codigo..."
